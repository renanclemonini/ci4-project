-- --------------------------------------------------------
-- Servidor:                     clemonini-db.ch8mm0woq17l.us-east-2.rds.amazonaws.com
-- Versão do servidor:           8.0.33 - Source distribution
...
CREATE DATABASE IF NOT EXISTS `quarentena_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `quarentena_db`;
...
-- Copiando dados para a tabela quarentena_db.ingressos: ~17 rows (aproximadamente)
INSERT INTO `ingressos` (`id`, `nome_completo`, `data_de_ingresso`, `whatsapp`, `cep`, `logradouro`, `complemento`, `bairro`, `localidade`, `uf`, `codigo_rastreio`, `detalhe_envio`, `created_at`, `updated_at`) VALUES
	...
	(18, 'Evelin Balbino do Nascimento', '2024-04-26', '7199217872', '42829710', 'Rodovia BA-099', 'Lote 01, Quadra 09. Ao lado do Posto F5', 'Arembepe (Abrantes)', 'Camaçari', 'BA', 'JN954498637BR', 'Objeto postado', '2024-05-04 18:38:56', '2024-05-11 17:52:50'),
	(20, 'Nasser Santos Boeri', '2024-04-30', '7181873007', '44470000', 'Estrada de Cacha Prego', 'Condominio Ponta da Ilha, 3ª etapa, 12', 'Cacha Prego', 'Vera Cruz', 'BA', 'JN954498623BR', 'Objeto postado', '2024-05-04 18:46:28', '2024-05-11 17:52:38'),
	(21, 'Erick Santos de Souza', '2024-05-09', '71996100721', '42828576', 'Rua Direta de Jauá', 'S/N - CT Vida Real, de frente ao Metal Clube', 'Jauá (Abrantes)', 'Camaçari', 'BA', 'JN954498668BR', 'Objeto postado', '2024-05-11 17:56:41', '2024-05-11 17:57:12'),
	(22, 'Ramon França da Silva Moreira', '2024-05-09', '73998259331', '45860000', 'Rua Castro Alves', '39, de frente ao centro espirita', 'Jardim Burundanga', 'Canavieiras', 'BA', 'JN954498654BR', 'Objeto postado', '2024-05-11 17:58:27', '2024-05-11 17:59:43'),
	(23, 'Marcos Paulo', '2024-05-10', '11981051917', '08655193', 'Rua Kame Yoshimoto', '741', 'Jardim Leblon', 'Suzano', 'SP', NULL, NULL, '2024-05-11 18:01:42', '2024-05-11 18:01:42');

-- Copiando estrutura para tabela quarentena_db.migrations
...
-- Copiando dados para a tabela quarentena_db.migrations: ~2 rows (aproximadamente)
INSERT INTO `migrations` (`id`, `version`, `class`, `group`, `namespace`, `time`, `batch`) VALUES
	(1, '2024-03-22-021136', 'App\\Database\\Migrations\\CreateTableUserMigration', 'rds_clemonini', 'App', 1715449705, 1),
	(2, '2024-03-22-223159', 'App\\Database\\Migrations\\CreatetableingressosMigration', 'rds_clemonini', 'App', 1715449705, 1);

-- Copiando estrutura para tabela quarentena_db.usuario
...
-- Copiando dados para a tabela quarentena_db.usuario: ~1 rows (aproximadamente)
INSERT INTO `usuario` (`id`, `nome`, `login`, `senha`, `created_at`, `updated_at`) VALUES
	(1, 'Renan Clemonini', 'rclemon93', '$2y$10$2X4Rc3vFGfY6lda7VNcD..ULhrINpYK4P5QRMTBLII8tVJEeJTzVi', '2024-05-11 17:49:06', '2024-05-11 17:49:06');
